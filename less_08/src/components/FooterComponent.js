    ...
    return (
        <footer class="footer">
            ...
            <section class="connect">
                <div class="connect__background"></div>
                <div class="connect__background-gradient"></div>
                <div class="container connect__wrap">

                    <div class="connect__info">
                        <img 
                            src={require(`../img/fice.png`)}
                            alt="" 
                        />
                    ...
                    <div class="connect__subscribe">
                        <div class="connect__name">
                            <h1>SUBSCRIBE <br />
                                <span class="smallText">FOR OUR NEWLETTER AND PROMOTION</span>
                            </h1>
                        </div>

                        <form class="connect__message">
                            <input class="connect__message__input" type="email" placeholder="Enter Your Email" />
                            <input class="connect__message__button" type="submit" value="Subscribe" />
                        </form>
                    </div>
            ...
            <section class="footer__contacts">
                <div class="container footer__wrap">
                    <div class="footer__copyright">© 2022 Brand All Rights Reserved.</div>
